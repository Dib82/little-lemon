        ...
        <main>
          <div className="flexH">
            <main className="header">
              <div className="nest">
                <h1 id="hero-title" className="displayTitle secondary-yellow">Little Lemon</h1>
                ...
                <div className="flex">
                  <Link to="/booking">
                  <button className="leadtext primary-green" aria-label="On Click">Reservations</button>
                  </Link>
                </div>
                </div>
                <div className="myimg flexH">
                  <img src="./images/3d3cce7a3104bf255ed0e69195e2a157338c1bff.jpg" alt="Chef carrying food"></img>
              </div>
            </main>
          </div>
        </main>
